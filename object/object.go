...
type Hash struct {
	// Why not map[HashKey]Object?
	// Keep track of the original Key and Value both!
	// Also useful for something like a range() function for the Hash data structure
...
// Interface to check if a given object is usable as a hash key.
// Can be used in the evaluator.
